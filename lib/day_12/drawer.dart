...
class DrawerDay12 extends StatefulWidget {
  const DrawerDay12({super.key});

  @override
  State<DrawerDay12> createState() => _DrawerDay12State();
}

class _DrawerDay12State extends State<DrawerDay12> {
  int _currentIndex = 0;
  ...
  static List<Widget> listWidget = [
    SingleChildScrollView(child: Example1Day10Screen()),
    SingleChildScrollView(child: Example2Day10Screen()),
    Text("data 3"),
    Text("data 3"),
  ];
